...
export function isClass(func) {
    ...
    // Support: IE 9-11 only IE 9-11 do not support classes and IE9 leaks with the
    // code below.
    ...
    if (!isBoolean(result)) {
        // Support: Edge 12-13 only See:
        // https://developer.microsoft.com/en-us/microsoft-edge/platform/issues/6156135/
